...
class FirebasePerformanceService {
  ...
  static Future<void> traceHttpRequest(String url, Future<void> Function() request) async {
    if (!_isEnabled) {
      await request();
      return;
    }
  ...
  static Future<void> traceFirestoreRead(String collection, Future<void> Function() read) async {
    if (!_isEnabled) {
      await read();
      return;
    }
