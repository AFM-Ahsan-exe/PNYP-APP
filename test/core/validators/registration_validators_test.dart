  ...
  group('RegistrationValidators', () {
    group('required', () {
      test('returns error for null value', () {
        expect(RegistrationValidators.required(null, 'Name'), 'Name is required');
      });
    ...
    group('cnic', () {
      ...
      test('returns error for 12 digits', () {
        expect(RegistrationValidators.cnic('123451234567'), 'Enter a valid 13-digit CNIC');
      });

      test('returns error for 14 digits', () {
        expect(RegistrationValidators.cnic('12345123456789'), 'Enter a valid 13-digit CNIC');
      });

      test('returns error for non-numeric characters', () {
        expect(RegistrationValidators.cnic('12345ABCDEF1'), 'Enter a valid 13-digit CNIC');
      });
    ...
    group('phone', () {
      ...
      test('returns error for invalid format', () {
        expect(RegistrationValidators.phone('1234567890'), 'Use a valid Pakistan mobile number');
      });
    ...
    group('email', () {
      ...
      test('returns error for invalid format', () {
        expect(RegistrationValidators.email('not-an-email'), 'Enter a valid email address');
      });
    ...
    group('password', () {
      ...
      test('returns error for password shorter than 6 chars', () {
        expect(RegistrationValidators.password('12345'), 'Password must be at least 6 characters');
      });
    ...
    group('age', () {
      test('returns error for age below 15', () {
        ...
        expect(RegistrationValidators.age(dob), 'Age must be between 15 and 35 years');
      });
